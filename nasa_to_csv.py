...
def extract_statistical_features(df: pd.DataFrame, column: str) -> pd.DataFrame:
...
def create_features(unprocessed_df: pd, query: list[str]) -> pd.DataFrame:
    ...
    unprocessed_df = extract_statistical_features(unprocessed_df, 'temperature')

    unprocessed_df = extract_statistical_features(unprocessed_df, 'current')

    unprocessed_df = extract_statistical_features(unprocessed_df, 'voltage')

    unprocessed_df = extract_statistical_features(unprocessed_df, 'resistance')
    ...
    unprocessed_df = extract_statistical_features(unprocessed_df, 'voltageRate')
